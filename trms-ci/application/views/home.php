...
<html lang="en">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-6">
                        <div class="text-center text-white">
                            <!-- Page heading-->
                            <h1 class="mb-5">Search Teacher Details!</h1>
                            <!-- Signup form-->
                            <!-- * * * * * * * * * * * * * * *-->
  ...
  <?php echo form_open('Search',['name'=>'Nameandemblems','class'=>'form-subscribe']);?>

                                <!-- Email address input-->
                                <div class="row">
                                    <div class="col">
                                        <input class="form-control form-control-lg" id="searhdata" type="text" name="searhdata" placeholder="Search teacher By Subject" required  />
